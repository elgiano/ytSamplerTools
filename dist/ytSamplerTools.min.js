...
const rand=(t=0,e=1)=>Math.random()*(e-t)+t,irand=(t=0,e=1)=>Math.round(Math.random()*(e-t)+t),coin=(t=.5)=>Math.random()<t,choose=t=>t[irand(0,t.length-1)],seq=t=>({pos:-1,get next(){return this.pos=(this.pos+1)%t.length,t[this.pos]}});function CallableInstance(t){var e=this.constructor.prototype[t],o=function(){return e.apply(o,arguments)};return Object.setPrototypeOf(o,this.constructor.prototype),Object.getOwnPropertyNames(e).forEach(function(t){Object.defineProperty(o,t,Object.getOwnPropertyDescriptor(e,t))}),o}CallableInstance.prototype=Object.create(Function.prototype),module.exports={rand:rand,irand:irand,coin:coin,choose:choose,CallableInstance:CallableInstance,seq:seq};
