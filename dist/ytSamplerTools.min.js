...
const{rand:rand,irand:irand,CallableInstance:CallableInstance}=require("./utils");class Looper extends CallableInstance{constructor(s){super("call"),this.sampler=s,this.loops={}}has(s){return!!this.loops[s]}add(s,t,e=1e3,a=!0){this.stop(s),this.loops[s]={fn:t,fnDelta:e,playing:a},this.run(s)}stop(s){this.has(s)&&(clearInterval(this.loops[s].id),delete this.loops[s])}isPlaying(s){return!!this.has(s)&&this.loops[s].playing}pause(s){this.has(s)&&(this.loops[s].playing=!1)}play(s){this.has(s)&&(this.loops[s].playing=!0,this.run(s))}toggle(s){this.has(s)&&(this.isPlaying(s)?pauseLoop(s):playLoop(s))}run(s){if(!this.isPlaying(s))return;let t=this.loops[s].fnDelta||.1;"function"==typeof t&&(t=this.loops[s].fnDelta()),console.log(`[${s}] next: ${t}`),this.loops[s].fn(),this.loops[s].id=setTimeout(()=>runLoop(s),1e3*t)}call(...s){this.add(...s)}stut(s){s<=0?pauseLoop("stut"):this.add("stut",()=>sampler.seekDelta(-s),()=>s/this.speed)}stutCur(s){const t=curPos();s<=0?pauseLoop("stut"):this.add("stut",()=>sampler.seek(t),()=>s/this.speed)}stutCurRand(s=.1,t=.2){const e=curPos();delta<=0?pauseLoop("stut"):this.add("stut",()=>sampler.seek(e),()=>rand(s,t)/this.speed)}stut2(s,t){null!=t?this.stutCurRand(s,t):this.stutCur(s)}skip(s,t,e,a,o){this.add(s,()=>this.seekDrand(t,e),()=>rand(t,e)/this.speed)}}module.exports=Looper;

},{"./utils":77}],76:[function(require,module,exports){
const ytdl=require("ytdl-core"),s2b=require("stream-to-blob"),YoutubePlayer=require("./youtubeFunctions"),Looper=require("./looper");window.ytdl=ytdl,window.s2b=s2b,window.yt=new YoutubePlayer,window.loop=new Looper(window.yt);const getBlob=o=>{o=o||window.location.href,console.log("[Preloading]",o);const e=ytdl(o);return e.on("progress",(o,e,r)=>console.log(`[Preloading] ${e/1024} of ${r/1024}MB`)),s2b(e).then(o=>{console.log("[Preloading] got blob:",o),document.querySelector("video").src=URL.createObjectURL(o)}),e};window.preload=getBlob;

},{"./looper":75,"./youtubeFunctions":78,"stream-to-blob":68,"ytdl-core":4}],77:[function(require,module,exports){
const rand=(t=0,e=1)=>Math.random()*(e-t)+t,irand=(t=0,e=1)=>Math.round(Math.random()*(e-t)+t);function CallableInstance(t){var e=this.constructor.prototype[t],r=function(){return e.apply(r,arguments)};return Object.setPrototypeOf(r,this.constructor.prototype),Object.getOwnPropertyNames(e).forEach(function(t){Object.defineProperty(r,t,Object.getOwnPropertyDescriptor(e,t))}),r}CallableInstance.prototype=Object.create(Function.prototype),module.exports={rand:rand,irand:irand,CallableInstance:CallableInstance};

},{}],78:[function(require,module,exports){
const{rand:rand,irand:irand}=require("./utils");class YoutubePlayer{get v(){return document.querySelector("video")}get curPos(){return this.v.currentTime}get dur(){return this.v.duration}get speed(){return this.v.playbackRate}get randPos(){return rand(0,this.dur)}seek(e){this.v.currentTime=e}seekRand(){this.seek(this.randPos)}seekDelta(e){this.seek(this.curPos+e)}seekDrand(e=-1,s=1){this.seekDelta(rand(e,s))}seekD(e,s){void 0===s?this.seekDelta(e):this.seekDrand(e,s)}set speed(e){this.v.playbackRate=e}modSpeed(e){this.speed=this.speed*e}randSpeed(e=-3,s=3){this.speed=Math.pow(2,rand(e,s))}sp(e,s){return null!=e&&(null!=s?randSpeed(e,s):this.speed=e),this.speed}pitchShift(e=!0){const s=this.v;null!=s.preservesPitch?s.preservesPitch=!e:null!=s.mozPreservesPitch?s.mozPreservesPitch=!e:null!=s.webkitPreservesPitch?s.webkitPreservesPitch=!e:console.warn("[pitchShift] not supported by this browser")}}module.exports=YoutubePlayer;
