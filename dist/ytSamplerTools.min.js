...
const ytdl=require("ytdl-core"),s2b=require("stream-to-blob"),YoutubePlayer=require("./youtubeFunctions"),Looper=require("./looper");window.ytdl=ytdl,window.s2b=s2b,window.y=new YoutubePlayer,window.l=new Looper(window.y);const getBlob=o=>{o=o||window.location.href,console.log("[Preloading]",o);const e=ytdl(o);return e.on("progress",(o,e,r)=>console.log(`[Preloading] ${e/1024} of ${r/1024}MB`)),s2b(e).then(o=>{console.log("[Preloading] got blob:",o),document.querySelector("video").src=URL.createObjectURL(o)}),e};window.preload=getBlob;
